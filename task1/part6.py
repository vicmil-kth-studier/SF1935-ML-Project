...
plt.savefig(f"posterior_{sample_count}_{noice_variance}.png")
...
plt.savefig(f"model_{sample_count}_{noice_variance}.png")

# Choose the first as our data point
data_point_x = samples_x[sample_count-1]
...
plt.savefig(f"likelihood_{sample_count}_{noice_variance}.png")
